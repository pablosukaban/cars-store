    ...
    <footer className="w-full bg-secondaryGray pt-8 text-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-4 flex flex-col items-center justify-center gap-4 text-center sm:gap-6 md:gap-8">
          <h2 className="text-4xl font-bold uppercase text-primaryOrange sm:text-6xl md:text-8xl">Приходите</h2>
          <p className="max-w-[130px] uppercase md:max-w-full md:text-xl">И УЕЗЖАЙТЕ НА СОБСТВЕННОМ АВТОМОБИЛЕ!</p>
        </div>
        <div className="flex flex-col items-start justify-center gap-x-6 gap-y-4 sm:items-center md:mt-6 md:flex-row">
          ...
          <div className="flex items-center justify-start gap-4 text-gray-400 sm:gap-2">
            ...
            <span>Дмитровское шоссе, 157с4, Москва, 127411</span>
          </div>
          <div className="flex items-center justify-start gap-4 text-gray-400 sm:gap-2">
      ...
      <div className="mt-8 border-t border-gray-500 px-4 py-6 text-center text-gray-500">Автор ВКР Приходько Илья</div>
    </footer>
  );
};
